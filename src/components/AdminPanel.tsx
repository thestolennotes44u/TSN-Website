...
const NON_DELETABLE_SLUGS = ['about']; // 'whats-new' is now deletable if you wish

const AdminPanel: React.FC = () => {
    const { user, logout, changePassword } = useAuth();
    const { settings, setSettings } = useSettings();
    const { streams, papers, contentItems, pages, homepageContent, addOrUpdateDoc, deleteDocById } = useData();
